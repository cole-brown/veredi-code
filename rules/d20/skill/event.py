...
class SkillRequest(SkillEvent):
    ...
    def __str__(self):
        return f"{self._str_name()}: {self.skill} :: context: {str(self._context)}"

    def __repr__(self):
        return f"<{self._str_name(self.__repr_name__())}: {self.skill} :: {repr(self._context)}>"
...
class SkillResult(SkillEvent):
    ...
    def __str__(self):
        return f"{self._str_name()}: {self.skill} = {self.amount} :: context: {str(self._context)}"

    def __repr__(self):
        return f"<{self._str_name(self.__repr_name__())}: {self.skill}={self.amount} :: {repr(self._context)}>"
